...
public class EstudoOrdenacao {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            int v[] = new int[n];
            /*
             * preencheVetor(v); // exibeVetor(v, "vetor gerado"); long inicio = new
             * Date().getTime(); bubbleSort(v); long fim = new Date().getTime();
             * System.out.println("\ntempo de ordenacao do Bubble para o tamanho " + n +
             * " = " + (fim - inicio) + "ms\n"); // exibeVetor(v,
